...
public class Reducejoin {
	...
	public static class CustsMapper extends Mapper<LongWritable, Text, Text, Text>
	{
		public void map(LongWritable key, Text value, Context c) throws IOException, InterruptedException
		{
			...
			c.write(new Text(parts[0]), new Text("custs\t" + parts[1]));
		}
	}
	...
	public static class TxnsMapper extends Mapper<LongWritable, Text, Text, Text>
	{
		public void map(LongWritable key, Text value, Context c) throws IOException, InterruptedException
		{
			String record = value.toString();
			String [] parts = record.split("'");
			c.write(new Text(parts[2]), new Text("txns\t" + parts[3]));
		}
	}
	...
	public static class ReduceJoinReducer extends Reducer<Text, Text, Text, Text>
	{
		public void reduce(Text key, Iterable<Text> values, Context c) throws IOException, InterruptedException
		{
			...
			c.write(new Text(name), new Text(str));
		}
	}
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException 
	{
		...
		//MultipleInputs.addInputPath(job, path1, TextInputFormat.class, CustsMapper.class);
